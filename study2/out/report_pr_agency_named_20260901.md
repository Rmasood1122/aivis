...
Generated 2026-09-01T21:55:17Z by make_report v0.1.0
...
## 2 · PRESENCE, BY FAMILY

Presence = the name appears anywhere in the response. First-three = the name
is among the first three candidates by position in the text. **First-three is
a position count, not a ranking**; no order-bias test has been run, so no
rank claim is made anywhere in this report.

### buyer_intent — n=41

| name | presence | 95% CI | first-three | 95% CI |
|---|---|---|---|---|
| Reputation Ink | 9.8% (4/41) | 3.9–22.5% | 9.8% (4/41) | 3.9–22.5% |
| Reputation Rhino | 7.3% (3/41) | 2.5–19.4% | 7.3% (3/41) | 2.5–19.4% |
| Credible PR | 0.0% (0/41) | 0.0–8.6% | 0.0% (0/41) | 0.0–8.6% |
| Clarity PR | 0.0% (0/41) | 0.0–8.6% | 0.0% (0/41) | 0.0–8.6% |
| Brandstyle | 0.0% (0/41) | 0.0–8.6% | 0.0% (0/41) | 0.0–8.6% |

### category — n=41

| name | presence | 95% CI | first-three | 95% CI |
|---|---|---|---|---|
| Clarity PR | 53.7% (22/41) | 38.7–67.9% | 53.7% (22/41) | 38.7–67.9% |
| Reputation Rhino | 19.5% (8/41) | 10.2–34.0% | 19.5% (8/41) | 10.2–34.0% |
| Reputation Ink | 9.8% (4/41) | 3.9–22.5% | 9.8% (4/41) | 3.9–22.5% |
| Brandstyle | 9.8% (4/41) | 3.9–22.5% | 9.8% (4/41) | 3.9–22.5% |
| Credible PR | 0.0% (0/41) | 0.0–8.6% | 0.0% (0/41) | 0.0–8.6% |
...
| name | presence | 95% CI | first-three | 95% CI |
|---|---|---|---|---|
| Reputation Ink | 24.0% (6/25) | 11.5–43.4% | 24.0% (6/25) | 11.5–43.4% |
| Brandstyle | 24.0% (6/25) | 11.5–43.4% | 24.0% (6/25) | 11.5–43.4% |
| Reputation Rhino | 0.0% (0/25) | 0.0–13.3% | 0.0% (0/25) | 0.0–13.3% |
| Credible PR | 0.0% (0/25) | 0.0–13.3% | 0.0% (0/25) | 0.0–13.3% |
| Clarity PR | 0.0% (0/25) | 0.0–13.3% | 0.0% (0/25) | 0.0–13.3% |

### long_tail — n=42

| name | presence | 95% CI | first-three | 95% CI |
|---|---|---|---|---|
| Reputation Rhino | 0.0% (0/42) | 0.0–8.4% | 0.0% (0/42) | 0.0–8.4% |
| Reputation Ink | 0.0% (0/42) | 0.0–8.4% | 0.0% (0/42) | 0.0–8.4% |
| Credible PR | 0.0% (0/42) | 0.0–8.4% | 0.0% (0/42) | 0.0–8.4% |
| Clarity PR | 0.0% (0/42) | 0.0–8.4% | 0.0% (0/42) | 0.0–8.4% |
| Brandstyle | 0.0% (0/42) | 0.0–8.4% | 0.0% (0/42) | 0.0–8.4% |
...
Present in **0 of 191** responses — 0.0%, 95% CI 0.0–2.0%.

**Absence claim.** Denominator 191 responses across 5 families. STATUS=COMPLETE for this file. This is one engine on one date through an extraction step whose error rate has not been measured; it does not establish absence from AI answers generally.
...
Decision-level, on the 24 prompts with the full run count:

| measure | stable | rate | 95% CI |
|---|---|---|---|
| identical name set across runs | 17 of 24 | 70.8% | 50.8–85.1% |
| identical first-three across runs | 17 of 24 | 70.8% | 50.8–85.1% |

Byte-difference and decision-difference are different quantities. Only the
rows in this table speak to whether the answer changed.
